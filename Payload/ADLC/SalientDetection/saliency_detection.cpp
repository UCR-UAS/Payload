...
vector<Mat> saliency_detection(Mat img);
...
vector<Mat> saliency_detection(Mat img)
{
  ...
  return CropTargets(Threshold,OriginalImage,SizeReduced);
...
vector<Mat> CropTargets(Mat imgThresh, Mat OriginalImage, int sizeReduced)
{
  Mat BorderedImage;
